...
Monk.create!(
    ...
    monk_description: "法然上人(1133年～1212年)はどのような人であっても救済されるべきと考え、徹底した平等を貫きました。その教えは『選択本願念仏集』にも表れており、「南無阿弥陀仏」と称える念仏こそが、人々が救われるための最善の実践であると説きました。煩悩を否定するのではなく、ありのままの人間性を受け入れたその教えは、多くの人に「おおらかさ」として映ったのでしょう。上人とは仏教における高僧への敬称です。",
    start_score: 43,
    end_score: 48,
...
Monk.create!(
  ...
  monk_description: "日蓮上人(1222年～1282年)は、飢饉、天変地異と混迷する時代に生き、より良い社会のために何が必要か模索し続けました。彼は既存の仏教の体制に対し改革的な姿勢を崩さずに、様々な迫害を受けながらもその信念を曲げることなく、布教を続けました。彼が鎌倉幕府に提出した、国の安定と繁栄のための道筋を示した『立正安国論』は有名です。日蓮宗では尊敬の念をこめて聖人という尊称を用います。",
  start_score: 26,
  end_score: 31,
...
Monk.create!(
  ...
  monk_description: "栄西禅師(1141年～1215年)は、禅の教えを中国大陸から日本に伝え、日本の仏教界に新たな道を切り開きました。彼は幼き日より仏教の教えを修養し、１０代で比叡山に上り修学に励みます。その後、より深く学ぶため２回にわたり中国（宋）にわたり臨済禅を修めました。また、鎌倉幕府の庇護得るために活動し、禅の普及を目指した姿勢に戦略家としての一面を感じさせます。さらに栄西禅師は禅の修行に役立つとして茶の効用に注目し、中国から茶種を持ち帰り現在の佐賀県吉野ヶ里町の霊仙寺の庭に植えたとされています。彼が広げた茶の文化は今日の日本の茶文化の基礎とされています。禅師とは仏教における高僧への敬称であり、特に禅宗において尊敬される僧侶に対して使用されます。",
  start_score: 20,
  end_score: 25,
...
Monk.create!(
  ...
  monk_description: "道元禅師(1200年～1253年)は幼くは比叡山で学び、その後更なる仏法の心理を求め各地の寺院を巡りました。その過程で禅に出会った道元禅師は、さらに深く禅を学ぶため中国（宋）に渡航しました。そこで出会う曹洞宗の如浄禅師の下で只管打座（雑念を捨て、ひたすらに座禅を行うこと）を行い悟りの境地に至りました。その後は帰国し、禅の思想を普及すべく活動を行うも、比叡山から反発を受け弾圧を受けます。この弾圧から逃れるため越前（福井県）へ移り、拠点を構えました。これは現在の永平寺であり道元禅師はこの場所で、座禅により深く自分の内面を見つめ直し、自らの悟りを伝えるため『正法眼蔵』の執筆をはじめました。禅師とは仏教における高僧への敬称であり、特に禅宗において尊敬される僧侶に対して使用されます。",
  start_score: 14,
  end_score: 19,
